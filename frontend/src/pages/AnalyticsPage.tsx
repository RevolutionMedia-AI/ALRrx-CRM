...
export default function AnalyticsPage() {
  ...
  return (
    <>
      ...
      <section className="w-full bg-pure-surface border border-whisper-border rounded-xl shadow-diffused overflow-hidden">
          ...
          <table className="w-full text-left text-sm border-collapse">
            ...
            <tbody>
              {sortedAgents.map((agent, i) => (
                <tr key={i} className="border-b border-whisper-border hover:bg-surface-container-lowest dark:hover:bg-gray-800/50">
